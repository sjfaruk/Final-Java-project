...
public class Time implements ActionListener {
    ...
    Time() {
        ...
        time = new JLabel("Time Converter");
        ...
        jLabel1 = new JLabel("Hour-Minute");
        ...
        jLabel2 = new JLabel("Minute-Secound");
        ...
        jLabel3 = new JLabel("Secound-Hour");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getActionCommand() == "radio1") {
            ...
            jText2.setText("" + (float) (a * 60) + " m");
        } else if (e.getActionCommand() == "radio2") {
            jLabel2.setText("Minute");
            jLabel3.setText("Secound");
            a = Double.parseDouble(jText1.getText());
            jText2.setText("" + (float) (a * 60) + " s");
        } else if (e.getActionCommand() == "radio3") {
            jLabel2.setText("Secound");
            jLabel3.setText("Hour");
            a = Double.parseDouble(jText1.getText());
            jText2.setText("" + (float) (a / 3600) + " h");
        } else if (e.getActionCommand() == "radio4") {
            jLabel2.setText("Day");
            jLabel3.setText("Hour");
            a = Double.parseDouble(jText1.getText());
            jText2.setText("" + (float) (a * 24) + " h");
        }
